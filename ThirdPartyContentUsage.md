...
2. **Mandatory Fan Content Disclaimer:** Every distribution channel (README, PDF header, Foundry module dialog) must include the exact WotC disclaimer (see Section 5).
...
## 4. Contributor Checklist: Writing a Conversion
...
- [ ] **3. No Artwork/Maps:** Are there any copyrighted art assets, logos, or maps included? (Only use public domain or self-created original art).
- [ ] **4. Clear Citation:** Does the entry include a citation pointing to the official book, DMs Guild title, or blog post for full lore?
- [ ] **5. No Paywall Material:** Is any of this material sourced from a private Patreon or subscription-only channel?

---

## 5. Required Legal Notices
